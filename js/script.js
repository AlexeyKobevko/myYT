...
function switchMode() {
    if (!night) {
        ...
        document.querySelectorAll('.hamburger > line').forEach(element => {
            element.style.stroke = '#fff';
        });

        document.querySelectorAll('.videos__item-descr').forEach(element => {
            element.style.color = '#fff';
        });

        document.querySelectorAll('.videos__item-views').forEach(element => {
            element.style.color = '#fff';
        });
...
function load() {
    gapi.client.init({
        'apiKey': 'AIzaSyAeddjo07QcL4WL0OXojYVyK_qExvJqMks',
...
function sliceTitle(selector, count) {
    document.querySelectorAll(selector).forEach(element => {
        ...
        if (element.textContent.length < 100) {
            ...
            const str = element.textContent.slice(0, count + 1) + '...';
